...
ضع `EMAIL_URL` في `.env` لإرسال فعلي، مثل `smtp+tls://USER:PASSWORD@smtp.example.com:587`. دونه تُطبع رسائل التنبيه في سجل العامل. اضبط البريد المستلم من لوحة التحكم في «المحتوى والإعدادات».
