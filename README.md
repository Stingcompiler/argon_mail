...
- الإدارة: الدخول بـ JWT، نظرة عامة، الطلبات مع التصفية والإسناد والحالات والملاحظات والسجل، المرفقات بروابط تنزيل موقّعة، عروض الأسعار والدفع وإثباته، الخدمات والمجالات والنماذج، الرسائل، الإعدادات والأسئلة الشائعة، الفريق، ومؤشر التخزين.
...
الوسائط العامة وصور الخدمات، تنبيهات البريد، سياسة الاحتفاظ بالمرفقات، الصفحات المخصصة والتنقل وإدارة الحالات من الواجهة، النسخ الاحتياطي، والنشر على Render. المعاينة الأصلية لهذه الشاشات محفوظة كمرجع على `/design-preview` عند ضبط `ENABLE_DESIGN_PREVIEW=1`، وبياناتها محلية في المتصفح فقط.
